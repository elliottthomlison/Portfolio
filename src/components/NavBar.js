  ...
  return (
    <nav class="bg-gray-900 py-10">
      ...
      <header class="flex items-center bg-gray-900 ">
        ...
        <NavLink to="/" exact activeClassName="text-white" className="inflex-flex items-center py-2 px-2 text-blue-100 text-6xl font-bold cursive tracking-widest">
          <Ripple >
            Elliott's Corner
          </Ripple>
        </NavLink> 
        ...
        <svg id="hamburger" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2.5" stroke-linecap="round" hover="color: gray" stroke-linejoin="round"><path d="M21 9.5H3M21 4.5H3M21 14.5H3M21 19.5H3"/></svg>
          </label>
        ...
        <div class="hidden md:flex md:items-center md:w-auto w-full" id="menu">
          <nav>
            ...
            <a id="resumeButton" className="no-underline button text-white inflex-flex items-center py-6 px-6 text-blue-100 text-4xl font-bold cursive tracking-widest">
              <Ripple>
                <td onClick={()=> window.open("https://drive.google.com/file/d/1s8I6jp4oxDH4t0GjRY61F4dn1DX8YZz_/view?usp=sharing")}>Resume</td>
              </Ripple>
            </a>
